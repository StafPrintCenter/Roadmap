...
export function ThemeToggle() {
  ...
  return (
    <button
      ...
      className="relative grid size-10 shrink-0 place-items-center rounded-xl border border-border bg-card text-foreground transition-colors hover:bg-secondary"
    >
